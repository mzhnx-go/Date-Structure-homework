...
constexpr auto qt_meta_stringdata_CLASSStudentWindowENDCLASS = QtMocHelpers::stringData(
    ...
    "on_exit_clicked",
    "",
    "on_show_course_clicked",
    "on_searchStu_clicked",
    "on_check_score_clicked",
    "on_cancel_course_clicked"
);
...
Q_CONSTINIT const QMetaObject StudentWindow::staticMetaObject = { {
    ...
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSStudentWindowENDCLASS_t,
        ...
        // method 'on_show_course_clicked'
        QtPrivate::TypeAndForceComplete<void, std::false_type>,
        // method 'on_searchStu_clicked'
        QtPrivate::TypeAndForceComplete<void, std::false_type>,
        // method 'on_check_score_clicked'
        QtPrivate::TypeAndForceComplete<void, std::false_type>,
        // method 'on_cancel_course_clicked'
        QtPrivate::TypeAndForceComplete<void, std::false_type>
    >,
    nullptr
} };
...
void StudentWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->on_show_course_clicked(); break;
        case 2: _t->on_searchStu_clicked(); break;
        case 3: _t->on_check_score_clicked(); break;
        case 4: _t->on_cancel_course_clicked(); break;
        default: ;
        }
    }
    (void)_a;
